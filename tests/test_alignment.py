...
class AlignmentMonitorTests(unittest.TestCase):
        ...
        mock_claude.create_message.return_value = json.dumps(
            {
                "requirements": [
                    {
                        "id": "R1",
                        "description": "Discord bot connects",
                        "category": "core",
                        "priority": "must",
                    },
                    {
                        "id": "R2",
                        "description": "Price alerts work",
                        "category": "feature",
                        "priority": "must",
                    },
                    {
                        "id": "R3",
                        "description": "README included",
    ...
    def test_alignment_report_passed_property(self) -> None:
        ...
        failing = AlignmentReport(
            checkpoint="t", requirements=[], checks=[], critical_gaps=["missing X"]
        )
